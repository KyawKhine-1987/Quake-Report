package net.freelance.android.quakereport.utility;
...
/**
 * Created by Kyaw Khine on 12/20/2016.
...
public final class QueryUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create an {@link Earthquake}s object
    ...
    private static String readFromStream(InputStream inputStream) throws IOException {
        ...
        if (inputStream != null) {
            InputStreamReader inputStreamReader =
                    new InputStreamReader(inputStream, Charset.forName("UTF-8"));//***UTF means Unicode Text Font.
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        List<Earthquake> earthquakes = new ArrayList<>();//*** List<> earthquakes = ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                Earthquake result = new Earthquake(magnitude, location, time, url);
